 ...
 * <br>
 * For BungeeCord? Use {@link me.axolotl.api.minecraft.bungee.util.PluginBuildInfo}
 *
 * @since 2024-02-08
...
public final class PluginBuildInfo {
    ...
    /**
     * Adds the events for the plugin.
     *
     * @param events The list of events.
     * @return This PluginBuildInfo instance.
     */
    public PluginBuildInfo addEvents(Listener... events) {
    ...
    /**
     * Adds the commands for the plugin.
     *
     * @param commands The list of command runnables.
     * @return This PluginBuildInfo instance.
     */
    public PluginBuildInfo addCommands(CommandRunnable... commands) {
